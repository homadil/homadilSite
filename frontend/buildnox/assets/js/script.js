(function ($) {
  ...
  $(document).ready(function () {
    ...
    $.getJSON(path, function (data) {
      ...
      $(".phone_one").each(function () {
        $(this)
          .text(data.phone_number_one)
          .attr("href", "tel:" + data.phone_number_one_link);
      });

      $(".phone_two").each(function () {
        $(this)
          .text(data.phone_number_two)
          .attr("href", "tel:" + data.phone_number_two_link);
      });
      ...
      $(".link_facebook").each(function () {
        $(this).attr("href", data.facebook);
      });

      $(".link_instagram").each(function () {
        $(this).attr("href", data.instagram);
      });

      $(".link_twitter").each(function () {
        $(this).attr("href", data.twitter);
      });

      $(".link_google").each(function () {
        $(this).attr("href", data.google);
      });
